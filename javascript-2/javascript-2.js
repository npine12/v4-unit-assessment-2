...
foods.forEach(food => {
  ...
  food['calories'] = (carbs * 4) + (fat * 9) + (protein * 4)
})
...
//CODE HERE
let blueProducts = saleProducts.filter(product => product.color.includes('blue') ? product : null);
////////////////////PROBLEM 4////////////////////
/*
...
//CODE HERE
let orderTotal = blueProducts.reduce((a, c) => {
  return a += c.price
}, 0)
//////////////////////////////////PROBLEMS 5-8//////////////////////////////////
/*
